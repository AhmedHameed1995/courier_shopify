(() => {
  ...
  function App() {
    ...
    const [listOrders, setOrders] = (0, import_react12.useState)([]);
    const [listOrders2, setOrders2] = (0, import_react12.useState)([]);
    (0, import_react12.useEffect)(() => {
      (function getOrderInfo() {
        return __async(this, null, function* () {
          const idsQuery = data.selected.map((id) => `id:${id.id.split("/").at(-1)}`).join(" OR ");
          const getOrderQuery = {
            query: `query {
          ...
          const orders2 = yield res.json();
          setOrders2(orders2.data);
          const orderData = orders2.data.orders.edges.map((order) => [
            // {
            //   id: order.node.id
            // },
            // order.map(premise => {
    ...
    const orders = ((_a = listOrders2 == null ? void 0 : listOrders2.orders) == null ? void 0 : _a.edges) || [];
    return (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        AdminAction2,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
            ...
            listOrders.map((order) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: order.id })),
            orders.map(({ node }) => (
              // Render the order id
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: node.id }, node.id)
            ))
          ] })
        }
      )
